...
image.onload = (evt) => {
    ...
    let h = Math.sqrt(Math.pow(bitmap.image.width, 2) + Math.pow(bitmap.image.height, 2));
...
function insertImage() {
    ...
    circle.graphics.beginFill("red").drawCircle(500 + translationOriginal.x, 120 + translationOriginal.y, 40).endFill();
    var circle1 = new createjs.Shape();
    circle1.graphics.beginFill("blue").drawCircle(0 + translationOriginal.x, 0 + translationOriginal.y, 25).endFill();
    var circle2 = new createjs.Shape();
    circle2.graphics.beginFill("green").drawCircle(originalSize.width + translationOriginal.x, originalSize.height + translationOriginal.y, 25).endFill();
...
stage_img.on("stagemousedown", (evt) => {
    ...
    ellipse.graphics.beginStroke("black").drawRect(newCoordinates.x - 25, newCoordinates.y - 25, 50, 50).endStroke;
